...
pub const package_data = struct {
    pub const _lynxzv7ndvg1 = Package{
        .directory = dirs._lynxzv7ndvg1,
    };
    pub const _yyhw90zkzgmu = Package{
        .directory = dirs._yyhw90zkzgmu,
        .pkg = Pkg{ .name = "network", .source = .{ .path = dirs._yyhw90zkzgmu ++ "/network.zig" }, .dependencies = null },
    };
...
pub const packages = &[_]Package{
    package_data._yyhw90zkzgmu,
    package_data._9k24gimke1an,
};

pub const pkgs = struct {
    pub const network = package_data._yyhw90zkzgmu;
    pub const hzzp = package_data._9k24gimke1an;
};
